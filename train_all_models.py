...
def train_popular_models():
    """Train models for popular stocks in GitHub Codespaces"""
    trainer = MLModelTrainer()
    
    # Popular NSE stocks that usually have good data
    stocks = [
    ...
    print("🚀 Starting model training in GitHub Codespaces...")
        ...
        for j, analysis_type in enumerate(analysis_types, 1):
            ...
            try:
                success, accuracy = trainer.train_stock_model(
                    stock, 
                    analysis_type, 
                    period='6mo',  # Shorter period for faster training
                    show_progress=False
                )
    ...
    if os.path.exists(models_dir):
        ...
        if model_files:
            ...
            for file in sorted(model_files)[:10]:
...
if __name__ == "__main__":
    ...
    print("\n🎯 Training completed in GitHub Codespaces!")
